...
async def show_subs(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("SuperGrok (10 د.ع - شهر)", callback_data='sub_grok')],
        ...
        [InlineKeyboardButton("YouTube (10 د.ع - 6 أشهر)", callback_data='sub_yt')],
...
async def handle_choice(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 1. إرسال تنبيه للمدير يحتوي على اسم المستخدم كرابط مباشر
    ...
    # 2. رسالة للمستخدم مع زر التواصل مع المدير
    # استبدلي USERNAME_OF_ADMIN بمعرف التليجرام الخاص بكِ (بدون @)
    keyboard = [[InlineKeyboardButton("💬 اضغط هنا للتواصل مع المدير", url="https://t.me/k7467655")]]
    
    await query.edit_message_text(
        f"✅ تم تسجيل طلبك ({choice}).\n"
        "اضغط على الزر أدناه للتواصل مع الإدارة وإتمام الدفع.",
        reply_markup=InlineKeyboardMarkup(keyboard)
    )
